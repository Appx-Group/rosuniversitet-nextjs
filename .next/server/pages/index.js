...
/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(3157);
...
function Home({ data , statusCode  }) {
    if (statusCode) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_error__WEBPACK_IMPORTED_MODULE_22__["default"], {
...
const getStaticProps = async ()=>{
    const res = await fetch(`https://api.rosuniversitet.com/dev/v1/home`);
...
var __webpack_exports__ = __webpack_require__.X(0, [686,675,676,664,290,118,5,863,955], () => (__webpack_exec__(4369)));
