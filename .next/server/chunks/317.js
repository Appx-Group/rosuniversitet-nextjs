...
const Contacts = ({ data  })=>{
    ...
    const onSubmit = (e)=>{
        ...
        if (name.length > 0 && emailInput.length > 0 && text.length > 0 && number.length >= 12) {
            react_hot_toast__WEBPACK_IMPORTED_MODULE_7__.toast.promise(axios__WEBPACK_IMPORTED_MODULE_3___default().post("https://api.rosuniversitet.com/dev/v1/message/create", {
                type: "message",
                name: name,
                phone: number,
                email: emailInput,
